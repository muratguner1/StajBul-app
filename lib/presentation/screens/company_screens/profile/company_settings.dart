...
import 'package:staj_bul_demo/data/repositories/company/common_repository.dart';
...
class _CompanySettingsPageState extends State<CompanySettingsPage> {
      ...
      if (_notificationsEnabled) {
        ...
        if (user != null) {
          FirebaseMessaging.instance
              .subscribeToTopic('company_applications_${user.uid}');
        }
      }
    });
  }
  ...
  Future<void> _toggleNotifications(bool value) async {
    ...
    final topicName = 'company_applications_${user.uid}';
      ...
      if (value) {
        ...
        if (settings.authorizationStatus == AuthorizationStatus.authorized) {
          ...
          AwesomeSnackBar.show(context,
              ...
              message: 'Yeni başvurularda anında haberiniz olacak.',
          ...
          AwesomeSnackBar.show(context,
              title: 'İzin Gerekli',
              message: 'Telefon ayarlarından bildirim izni vermelisiniz.',
        ...
        AwesomeSnackBar.show(context,
            ...
            message: 'Artık başvuru bildirimi almayacaksınız.',
            contentType: ContentType.help);
      }
    } catch (e) {
      AwesomeSnackBar.show(context,
          title: 'Hata',
          message: 'Bildirim ayarı güncellenemedi.',
  ...
  void _showDeleteAccountDialog() {
    showDialog(
      ...
      builder: (dialogContext) => AlertDialog(
        title: const Text("Şirket Hesabını Sil",
            style: TextStyle(color: Colors.red)),
        content: const Text(
          "Hesabınızı kalıcı olarak silmek istediğinize emin misiniz? Şirket profiliniz, açtığınız tüm ilanlar ve verileriniz silinecektir.",
        ),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          const CustomSectionHeader(title: 'Hesap'),
          CustomSettingsTile(
          ...
          const Divider(),
          const CustomSectionHeader(title: 'Uygulama'),
          _isLoadingNotifications
              ...
              : SwitchListTile(
                  ...
                  subtitle: const Text(
                      'İlanlarınıza başvuru geldiğinde haber verilecek'),
          ...
          const Divider(),
          const CustomSectionHeader(title: 'Destek & Hakkında'),
          CustomSettingsTile(
            ...
            onTap: () => CustomInfoDialog.show(context,
                title: 'Yardım Merkezi',
                content:
                    'StajBul uygulamasında staj ilanı yayınlamak veya profilinizi düzenlemekle ilgili sorun yaşıyorsanız stajbul@destek.com adresine e-posta gönderebilirsiniz.'),
          ),
          CustomSettingsTile(
            icon: Icons.help_outline,
